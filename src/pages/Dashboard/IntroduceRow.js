...
const IntroduceRow = memo(({ loading, visitData }) => (
  <Row gutter={24}>
    <Col {...topColResponsiveProps}>
      <ChartCard
        bordered={false}
        title={<FormattedMessage id="app.analysis.total-sales" defaultMessage="Total Sales" />} //标题
        action={
          <Tooltip
        ...
        loading={loading}
        total={() => <Yuan>126560</Yuan>} //数据
        footer={
          <Field
            label={<FormattedMessage id="app.analysis.day-sales" defaultMessage="Daily Sales" />} //日销售额
            value={`￥${numeral(12423).format('0,0')}`} //格式化 金钱 租金
          />
        }
        contentHeight={46}
      >
